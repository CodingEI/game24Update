...
$(".0-9 .bet-num-line").click(function (e) {
  ...
  if (checkClass) {
    ...
    result();
    return $(`.0-9 .bet-num-line[txt=${info}] .bet-box-num`).removeClass(
      "active",
    );
  }
...
function GetMyEmerdList(datas) {
  ...
  let html = datas
    .map((data, index) => {
      ...
      const finalResult =
        data.join_bet == "total"
          ? arr.map((data) => parseInt(data)).reduce((a, b) => a + b, 0)
          : data.result[tab_index];
...
="">
      ...
      let displayIconClass, displayIconHtml;
      if (data.bet == "c") {
        ...
        displayIconClass = `l-${data.bet.split("")[0]}`;
        displayIconHtml = data.bet.split("")[0];
      } else {
        displayIconClass = `l-${list_order.bet}`;
        displayIconHtml = data.bet;
      }

      return `
         <div data-v-b4b99df8="" class="MyGameRecordList__C-item" onclick="openGameBetDetails(${index})">
            <div data-v-b4b99df8="" class="MyGameRecordList__C-item-l MyGameRecordList__C-item-${displayIconClass}">${displayIconHtml}</div>
            ...
            ${
              data.status !== 0
                ? `<div data-v-b4b99df8="" class="MyGameRecordList__C-item-r ${data.status == 1 ? "success" : ""}">
                        ...
                        <span data-v-b4b99df8="">${data.status == 1 ? `${parseFloat(data.get).toFixed(2)}` : `-${parseFloat(data.price).toFixed(2)}`}</span>
                     </div>`
                : ""
            }
         </div>
         ...
         <div data-v-b4b99df8="" class="MyGameRecordList__C-detail details_box_${index}" style="display: none;">
            ...
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               Purchase amount
               <div data-v-b4b99df8="">${parseFloat(data.money).toFixed(2)}</div>
            </div>
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               Quantity
               <div data-v-b4b99df8="">${parseFloat(data.amount).toFixed(2)}</div>
            </div>
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               Amount after tax
               <div data-v-b4b99df8="" class="red">${parseFloat(data.price).toFixed(2)}</div>
            </div>
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               Tax
               <div data-v-b4b99df8="">${parseFloat(data.fee).toFixed(2)}</div>
            </div>
            ...
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               ...
               <div data-v-b4b99df8="" class="line1">
                  ...
                  <div data-v-b4b99df8="" class="num">${parseFloat(data.bet).toFixed(2)}</div>
               </div>
            </div>
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line" style="display:${data.status == 0 ? "none" : ""};">
               Status
            ...
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line" style="display:${data.status == 0 ? "none" : ""};">
               Win/lose
               <div data-v-b4b99df8="" class="${data.status == 1 ? "green" : "red"}">${data.status == 1 ? `${parseFloat(data.get).toFixed(2)}` : `- ${parseFloat(data.price).toFixed(2)}`}</div>
            </div>
            <div data-v-b4b99df8="" class="MyGameRecordList__C-detail-line">
               Order time
...
function openChartStatisticsTab(tab) {
  ...
  if (tab === "A") {
    ...
    $("#chart_max_consecutive_box").html(
      GAME_CHART_STATISTICS_HTML.A.MAX_CONSECUTIVE,
    );
  } else if (tab === "B") {
    removeActiveTab();
    ...
    $("#chart_max_consecutive_box").html(
      GAME_CHART_STATISTICS_HTML.B.MAX_CONSECUTIVE,
    );
  } else if (tab === "C") {
    removeActiveTab();
    ...
    $("#chart_max_consecutive_box").html(
      GAME_CHART_STATISTICS_HTML.C.MAX_CONSECUTIVE,
    );
  } else if (tab === "D") {
    removeActiveTab();
    ...
    $("#chart_max_consecutive_box").html(
      GAME_CHART_STATISTICS_HTML.D.MAX_CONSECUTIVE,
    );
  } else if (tab === "E") {
    removeActiveTab();
    ...
    $("#chart_max_consecutive_box").html(
      GAME_CHART_STATISTICS_HTML.E.MAX_CONSECUTIVE,
    );
  } else {
    console.log("No tab");
  }
