...
const o = {
  ...
  tipEarningsCaculatedEveryMinites:
    "After the balance is transferred in, profit will be calculated once every {0} minute",
  ...
  code332:
    "Two full selection and first prize mantissa cannot use multiple selection",
  code333: "Game closed",
  ...
  titleGot: "Receive",
  dailyRateReturn:
    "The daily interest rate is {0}%, and the income is calculated once every {1} minutes.",
  prompt: "Notification",
  ...
  partnerRule: `eg: <br/> Player A 1st deposit <span style="color:var(--norm_red-color)">{0}</span> and turnover <span style="color:var(--norm_red-color)">{1}</span>, you can't get bonus`,
  partnerRule2:
  ...
  code1002: "InviteCode has expired",
  ...
  prblmslveMsg:
    "You can leave a message to tell us and we will handle the problem faster",
  succsAppeal: "We will deal with your problem as quickly as possible",
  payAttn:
    "Please pay attention to the processing results of the recharge order list",
  ...
  turnover: "Turnover",
  partnerTip1: "*Each deposit can only get one bonus.",
  ...
  code1006:
    "The requirement does not meet to claim this event，contact superior agent for assistance",
  ...
  dailyRateReturn2:
    "Half-hour interest rate {0}%, earnings calculated once every {1} minutes",
