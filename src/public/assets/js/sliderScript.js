...
async function runSliderVerification() {
    ...
    await page.waitForTimeout(3000) // Update with waitForTimeout

    await browser.close()

    return bestSlider.position
}

module.exports = runSliderVerification
